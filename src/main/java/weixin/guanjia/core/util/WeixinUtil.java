...
public class WeixinUtil {
    ...
    //获取发送人昵称
    public  static String getUserInfo_url = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN";
    //群发接口
    public  static String qunfa_url  = "https://api.weixin.qq.com/cgi-bin/message/mass/sendall?access_token=ACCESS_TOKEN";
    //
